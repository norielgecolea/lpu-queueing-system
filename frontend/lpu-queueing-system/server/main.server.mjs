...
function _document() {
  ...
  if (config3 && config3.document) {
    document2 = typeof config3.document === "string" ? _enableDomEmulation ? parseDocument(config3.document, config3.url !== void 0 ? parseUrl(config3.url, "http://localhost").href : void 0) : window.document : config3.document;
  } else {
...
var routes = [
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-UAZ2BI3L.mjs").then((m) => m.LoginPage)
  }, true ? { \u0275entryName: "src/app/pages/login/login.page.ts" } : {}),
  __spreadValues({
    path: "teller",
    title: "LPU Queue \xB7 Teller",
    canActivate: [tellerGuard],
    loadComponent: () => import("./chunk-ILPBKBDN.mjs").then((m) => m.TellerPage)
  }, true ? { \u0275entryName: "src/app/pages/teller/teller.page.ts" } : {}),
  __spreadValues({
    path: "customer",
    title: "LPU Queue \xB7 Get a Number",
    loadComponent: () => import("./chunk-QTTB5O2W.mjs").then((m) => m.CustomerPage)
  }, true ? { \u0275entryName: "src/app/pages/customer/customer.page.ts" } : {}),
  __spreadValues({
    path: "display",
    title: "LPU Queue \xB7 Now Serving",
    loadComponent: () => import("./chunk-SPCB4HSN.mjs").then((m) => m.DisplayPage)
  }, true ? { \u0275entryName: "src/app/pages/display/display.page.ts" } : {}),
