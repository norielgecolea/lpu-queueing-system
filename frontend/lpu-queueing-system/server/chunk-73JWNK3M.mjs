...
// libs/ui/label/src/lib/hlm-label.ts
var HlmLabel = class _HlmLabel {
  constructor() {
  ...
  static \u0275fac = function HlmLabel_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _HlmLabel)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _HlmLabel, selectors: [["", "hlmLabel", ""]], hostAttrs: ["data-slot", "label"], features: [\u0275\u0275HostDirectivesFeature([{ directive: BrnLabel, inputs: ["id", "id", "for", "for"] }])] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HlmLabel, [{
    type: Directive,
    args: [{
      selector: "[hlmLabel]",
...
//# sourceMappingURL=chunk-73JWNK3M.mjs.map
