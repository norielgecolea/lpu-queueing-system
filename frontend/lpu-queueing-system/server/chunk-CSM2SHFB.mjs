...
// libs/ui/utils/src/lib/hlm.ts
function hlm(...inputs) {
  return twMerge(clsx(inputs));
}
var elementClassManagers = /* @__PURE__ */ new WeakMap();
var globalObserver = null;
var observedElements = /* @__PURE__ */ new Set();
var sourceCounter = 0;
function classes(computed2, options = {}) {
  runInInjectionContext(options.injector ?? inject(Injector), () => {
    ...
    if (!manager) {
      const initialBaseClasses = /* @__PURE__ */ new Set();
      if (baseClasses) {
    ...
    function updateClasses() {
      const newClasses = toClassList(computed2());
...
function restoreTransitionSuppression(manager) {
  ...
  if (prev) {
    manager.element.style.setProperty("transition", prev, manager.previousTransitionPriority || void 0);
  } else {
      ...
      for (const mutation of mutations) {
        if (mutation.type === "attributes" && mutation.attributeName === "class") {
          ...
          if (manager && observedElements.has(element)) {
            ...
            const allSourceClasses = /* @__PURE__ */ new Set();
...
function updateElement(manager) {
  ...
  if (!manager.hasInitialized && manager.sources.size > 0) {
    ...
    const allSourceClasses2 = /* @__PURE__ */ new Set();
    for (const source of manager.sources.values()) {
      source.classes.forEach((className) => allSourceClasses2.add(className));
    }
    currentClasses.forEach((className) => {
      if (!allSourceClasses2.has(className)) {
        manager.baseClasses.add(className);
      }
    });
...
// libs/ui/button/src/lib/hlm-button.token.ts
var defaultConfig = {
  variant: "default",
  size: "default"
};
...
var HlmButton = class _HlmButton {
  ...
  setClass(classes2) {
    this._additionalClasses.set(classes2);
  }
  static \u0275fac = function HlmButton_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _HlmButton)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _HlmButton, selectors: [["button", "hlmBtn", ""], ["a", "hlmBtn", ""]], hostAttrs: ["data-slot", "button"], inputs: { variant: [1, "variant"], size: [1, "size"] }, exportAs: ["hlmBtn"], features: [\u0275\u0275HostDirectivesFeature([{ directive: BrnButton, inputs: ["disabled", "disabled"] }])] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HlmButton, [{
    type: Directive,
    args: [{
  ...
  }], () => [], { variant: [{ type: Input, args: [{ isSignal: true, alias: "variant", required: false }] }], size: [{ type: Input, args: [{ isSignal: true, alias: "size", required: false }] }] });
})();

// src/app/shared/lpu-button.ts
var VARIANT_CLASSES = {
  primary: "bg-lpu-maroon text-white border-lpu-maroon hover:bg-lpu-gold hover:text-lpu-maroon hover:border-lpu-gold disabled:opacity-50 disabled:pointer-events-none",
  secondary: "bg-transparent text-lpu-maroon dark:text-lpu-gold border border-lpu-maroon dark:border-lpu-gold hover:bg-lpu-gold hover:text-lpu-maroon hover:border-lpu-gold dark:hover:bg-lpu-gold dark:hover:text-lpu-maroon dark:hover:border-lpu-gold disabled:opacity-50 disabled:pointer-events-none"
};
var LpuButton = class _LpuButton {
  ...
  userClass = input("", __spreadProps(__spreadValues({}, ngDevMode ? { debugName: "userClass" } : (
    /* istanbul ignore next */
    {}
  )), { alias: "class" }));
  ...
  static \u0275fac = function LpuButton_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LpuButton)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _LpuButton, selectors: [["button", "lpuBtn", ""], ["a", "lpuBtn", ""]], hostAttrs: ["data-slot", "button"], hostVars: 2, hostBindings: function LpuButton_HostBindings(rf, ctx) {
    if (rf & 2) {
      \u0275\u0275classMap(ctx._computedClass());
    }
  }, inputs: { variant: [1, "variant"], size: [1, "size"], userClass: [1, "class", "userClass"] }, exportAs: ["lpuBtn"], features: [\u0275\u0275HostDirectivesFeature([{ directive: BrnButton, inputs: ["disabled", "disabled"] }])] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LpuButton, [{
    type: Directive,
    args: [{
  ...
  }], null, { variant: [{ type: Input, args: [{ isSignal: true, alias: "variant", required: false }] }], size: [{ type: Input, args: [{ isSignal: true, alias: "size", required: false }] }], userClass: [{ type: Input, args: [{ isSignal: true, alias: "class", required: false }] }] });
})();
...
//# sourceMappingURL=chunk-CSM2SHFB.mjs.map
