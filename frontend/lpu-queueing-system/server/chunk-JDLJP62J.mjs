...
var STORAGE_KEY = "lpu-queue-session-v1";
var AuthStore = class _AuthStore {
  isBrowser = isPlatformBrowser(inject(PLATFORM_ID));
  _session = signal(this.load(), ...ngDevMode ? [{ debugName: "_session" }] : (
    /* istanbul ignore next */
    []
  ));
  session = this._session.asReadonly();
  isAuthenticated = computed(() => this._session() !== null, ...ngDevMode ? [{ debugName: "isAuthenticated" }] : (
    /* istanbul ignore next */
    []
  ));
  login(session) {
  ...
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AuthStore, factory: _AuthStore.\u0275fac, providedIn: "root" });
};
(() => {
...
//# sourceMappingURL=chunk-JDLJP62J.mjs.map
